...
class Aviso(models.Model):
    ...
    email = models.EmailField()
    archivo_pdf = models.FileField(upload_to='pdfs/', blank=True, null=True)
    CATEGORIA_CHOICES =  [('Balances_y_Estados_Financieros' , 'Balances y Estados Financieros'),
    ('Citaciones' , 'Citaciones'),
    ('Concesiones_Ministerio_Obras_Públicas' , 'Concesiones Ministerio Obras Públicas'),
    ('Concursos,_Sorteos_Letras_Hipotecarias,_Pago_Dividendos,_Emisión_de_Bonos_Bancarios' , 'Concursos, Sorteos Letras Hipotecarias, Pago Dividendos, Emisión de Bonos Bancarios'),
    ('Extractos/Concesiones' , 'Extractos/Concesiones'),
    ('Extraví­o_de_Documentos_y_Ordenes_de_No_Pago' , 'Extraví­o de Documentos y Ordenes de No Pago'),
    ('Extravío_de_Títulos' , 'Extravío de Títulos'),
    ('Fé_de_erratas' , 'Fé de erratas'),
    ('Hecho_Esencial,_Opción_Preferente,_Disminución_de_Capital,_OPA.' , 'Hecho Esencial, Opción Preferente, Disminución de Capital, OPA.'),
    ('Licitaciones,_Ventas,_Remates_y_Propuestas' , 'Licitaciones, Ventas, Remates y Propuestas'),
    ('Ministerio_de_economía' , 'Ministerio de economía'),
    ('Municipalidades,_Extractos_Licitaciones,_Ordenanzas' , 'Municipalidades, Extractos Licitaciones, Ordenanzas'),
    ...
    ('Órdenes_de_No_Pago_Banco_Del_Desarrollo' , 'Órdenes de No Pago Banco Del Desarrollo'),
    ...
    ('Órdenes_de_No_pago_Multiservicios_OK' , 'Órdenes de No pago Multiservicios OK'),
    ('OTIC_-_Camara_de_la_Construcción' , 'OTIC - Camara de la Construcción'),
    ('Otros' , 'Otros'),
    ('Posesiones_Efectivas' , 'Posesiones Efectivas'),
    ('Posesiones_Efectivas_Registro_Civil_R._Metropolitana' , 'Posesiones Efectivas Registro Civil R. Metropolitana'),
    ('Publicaciones_Accionistas_Fallecidos_y_Listado_de_Asegurados_Fallecidos' , 'Publicaciones Accionistas Fallecidos y Listado de Asegurados Fallecidos'),
